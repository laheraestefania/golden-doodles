...
//
// function createVis() {
//     var tree = new treegraph("tree", alldata);
// }

// treegraph = function(_parentElement, _data, field) {
...
// treegraph.prototype.wrangleData = function() {
//     vis = this;
//
...
//         .entries(csv);
//
//     vis.root = d3.hierarchy({values: vis.displayData}, function(d) {return d.values;});
//
//     vis.root.x0 = height / 2;
//     vis.root.y0 = 0;
//
