Bubble = function(_parentElement, _data, topology, feature){
    this.parentElement = _parentElement;
    this.data = _data;
    this.displayData = []; // see data wrangling
    this.feature = feature;

    this.margin = {top: 0, right: 120, bottom: 30, left: 60};
    ...
    this.maxRadius = this.height*0.1;
    // total number of nodes
    this.n = vis.data.length;
    // total number of clusters
    this.m = 10;
    this.scale = d3.scaleOrdinal(d3.schemeCategory20);
